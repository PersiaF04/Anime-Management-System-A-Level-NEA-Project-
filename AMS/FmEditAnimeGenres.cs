...
{
    /// <summary>
    /// Handles all inputs and validation of functions that will take place in <c>FmEditAnimeGenres</c>
    /// </summary>
    public partial class FmEditAnimeGenres : Form
    {
        ...
        private void btInsert_Click(object sender, EventArgs e)
        {
            try// Exception Handling
            {
                ...
                Cmd.CommandText = "INSERT INTO AnimeGenres VALUES("+ tbAnimeID.Text +","+ tbGenreID.Text + ")";
        ...
        private void btUpdate_Click(object sender, EventArgs e)
        {
            try//Exception Handling
            {
                ...
                //Updates the information contained in GenreID with the textbox tbGenreID. This update will take place in where the AnimeID is same as the textbox tbAnimeID
                Cmd.CommandText ="UPDATE AnimeGenres SET GenreID= "+tbGenreID.Text+" WHERE AnimeID="+tbAnimeID.Text+"";
        ...
        private void btDelete_Click(object sender, EventArgs e)
        {
            try//Exception Handling
            {
                ...
                Cmd.CommandText = "DELETE FROM AnimeGenres WHERE AnimeID= "+tbAnimeID.Text+"";
